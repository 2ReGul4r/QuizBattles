import { sendUpdates, doesRoomExist, isHostOfRoom, setActiveBuzzer, hasRoomActiveQuestion, checkActiveQuestionType, hasRoomActiveBuzzer, buzzedBefore } from "../utils/quizbattleUtils.js";
    ...
    if (!buzzerTimeout) {
        buzzerTimeout = setTimeout(() => {
            if (buzzerEvents.length > 0) {
                ...
                setActiveBuzzer(firstBuzz.userID, firstBuzz.username, roomID);
                sendUpdates(roomID);
