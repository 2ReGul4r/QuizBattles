import { getCurrentRoomOfUserID, doesRoomExist, isHostOfRoom, isUserInThisRoom, hasRoomActiveQuestion, checkActiveQuestionType, markGuessAsWrong, sendUpdates } from "../utils/quizbattleUtils.js";
...
export default (socket, userID) => {
    ...
    markGuessAsWrong(userID, roomID);
    sendUpdates(roomID);
};
